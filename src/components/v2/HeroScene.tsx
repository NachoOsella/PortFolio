...
const cubeFaces = [
  ...
  { side: 'back', tone: 'green', index: '03', label: 'DATA', value: 'API', detail: 'contracts' },
  { side: 'left', tone: 'orange', index: '04', label: 'FLOW', value: 'SPRING', detail: 'runtime' },
  { side: 'top', tone: 'aqua', index: '05', label: 'SHIP', value: 'WEB', detail: 'delivery' },
  { side: 'bottom', tone: 'purple', index: '06', label: 'SCALE', value: 'TS', detail: 'clarity' },
];
